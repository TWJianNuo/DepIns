...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        save_dir = "/media/shengjie/other/sceneUnderstanding/monodepth2/kitti_data/monodepth2_depth_prediction"
        ...
        with torch.no_grad():
            for idx, data in enumerate(dataloader):
                ...
                for k in range(depth.shape[0]):
                    ...
                    save_folder = os.path.join(save_dir, comps[0], mapping[comps[2]])
