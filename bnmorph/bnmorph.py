...
class BNMorphFunction(Function):
    @staticmethod
    def bnmorph(binMapsrc, binMapdst, xx, yy, sxx, syy, cxx, cyy, pixel_distance_weight, alpha_distance_weight, pixel_mulline_distance_weight, alpha_padding):
...
class BNMorph(nn.Module):
    ...
    def bnmorph(self, binMapsrc, binMapdst):
        return BNMorphFunction.bnmorph(binMapsrc, binMapdst, self.xx, self.yy, self.sxx, self.syy, self.cxx, self.cyy, self.pixel_distance_weight, self.alpha_distance_weight, self.pixel_mulline_distance_weight, self.alpha_padding)